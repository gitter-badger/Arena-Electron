...
If there are any errors, open an issue following the Issue section of the [Contribution Guide](about/contrib.md)
...
Please read [Contribution Guide](about/contrib.md) for details on our code of conduct, and the process for submitting pull requests to us.
...
This project is licensed under the MIT License - see the [LICENSE.md](about/license.md) file for details
